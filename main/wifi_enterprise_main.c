...
#define TAG "golioth_example_wpa2"
...
void app_main(void)
{
    ...
    const char* psk_id = "20240305213323-esp32-office-golioth-wpa2@smart-return-bin";
    const char* psk = "6ab49c1d2ad9ccf23ab83c7908b0da22";
